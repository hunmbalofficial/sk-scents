          ...
          <div className="relative bg-luxury-card rounded-2xl p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto border border-luxury-gold/10">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div><label className="block text-sm text-luxury-gray mb-1">Top Notes (comma separated)</label><input value={form.topNotes} onChange={(e) => setForm({ ...form, topNotes: e.target.value })} className="input-luxury w-full rounded-lg px-4 py-2.5 text-sm" placeholder="Bergamot, Lemon" /></div>
                <div><label className="block text-sm text-luxury-gray mb-1">Middle Notes</label><input value={form.middleNotes} onChange={(e) => setForm({ ...form, middleNotes: e.target.value })} className="input-luxury w-full rounded-lg px-4 py-2.5 text-sm" placeholder="Rose, Jasmine" /></div>
                <div><label className="block text-sm text-luxury-gray mb-1">Base Notes</label><input value={form.baseNotes} onChange={(e) => setForm({ ...form, baseNotes: e.target.value })} className="input-luxury w-full rounded-lg px-4 py-2.5 text-sm" placeholder="Musk, Sandalwood" /></div>
